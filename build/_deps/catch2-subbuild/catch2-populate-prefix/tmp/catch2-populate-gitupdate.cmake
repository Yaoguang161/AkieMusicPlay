...
execute_process(
  COMMAND "D:/software/Git/Git/cmd/git.exe" --git-dir=.git show-ref "v2.13.4"
  WORKING_DIRECTORY "E:/software/Code/AkieMusicPlay/3rdParty/catch2/406a07db1ac202c2253293c0369ea576800cb47e"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'E:/software/Code/AkieMusicPlay/3rdParty/catch2/406a07db1ac202c2253293c0369ea576800cb47e'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'E:/software/Code/AkieMusicPlay/3rdParty/catch2/406a07db1ac202c2253293c0369ea576800cb47e'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()

...
execute_process(
  COMMAND "D:/software/Git/Git/cmd/git.exe" --git-dir=.git show-ref "v1.8.5"
  WORKING_DIRECTORY "E:/software/Code/AkieMusicPlay/3rdParty/spdlog/be9796fe42cf4cd102be04c44dd3c83ff2a4d1c0"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'E:/software/Code/AkieMusicPlay/3rdParty/spdlog/be9796fe42cf4cd102be04c44dd3c83ff2a4d1c0'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'E:/software/Code/AkieMusicPlay/3rdParty/spdlog/be9796fe42cf4cd102be04c44dd3c83ff2a4d1c0'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
